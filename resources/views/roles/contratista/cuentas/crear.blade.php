@extends('layouts.app')
@section('title', 'Crear Cuenta de Cobro - Contratista')
...
<div class="pt-24 pb-8 px-4 sm:px-6 lg:px-8 min-h-screen">
    ...
    <div class="max-w-4xl mx-auto">
        <form action="{{ route('contratista.cuentas.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
                    ...
                    <div class="glass-card p-6">
                        ...
                        <div>
                            ...
                            <textarea id="descripcion" 
                                      ...
                                      class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors resize-none @error('descripcion') border-red-300 @enderror">{{ old('descripcion') }}</textarea>
                            @error('descripcion')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="glass-card p-6">
                        <div class="flex items-center mb-6">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600 text-sm">Adjunte los archivos que respalden su cuenta de cobro</p>
                            </div>
                        </div>
                        ...
                        <div class="border-2 border-dashed border-gray-300 rounded-xl p-6 hover:border-blue-400 transition-colors">
                            <div class="text-center">
                                ...
                                <label for="documentos" class="cursor-pointer">
                                    <span class="text-lg font-medium text-gray-700">Seleccionar archivos</span>
                    ...
                    <div class="glass-card p-6 sticky top-24">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                <span class="text-sm text-gray-600">Estado inicial:</span>
                        ...
                        <div class="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                            <div class="flex items-start">
                                ...
                                <div class="text-sm text-blue-700">
                                    <p class="font-medium mb-1">¿Qué pasa después?</p>
                                    <ol class="list-decimal list-inside space-y-1 text-xs">
                                        <li>Se guardará como borrador</li>
                                        <li>Podrás editarla antes de enviar</li>
                                        <li>Al enviar, irá a revisión</li>
                ...
                <div class="glass-card p-6">
                    <div class="flex flex-col sm:flex-row items-center justify-between space-y-4 sm:space-y-0 sm:space-x-4">
                        <div class="flex items-center text-sm text-gray-600">
                            ...
                            Se guardará como borrador. Podrás editarla antes de enviarla.
                        </div>
